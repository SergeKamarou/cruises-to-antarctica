...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_mobile_menu__WEBPACK_IMPORTED_MODULE_1__["initMobileMenu"])();
...
function init() {
  ...
  var placemark = new ymaps.Placemark([59.93868425386648, 30.3230366711649], {}, {
...
var mobileMenuElement = document.querySelector('[data-mobile-menu]');
var menuToggleElement = document.querySelector('[data-menu-toggle]');
var menuOverlayElement = document.querySelector('[data-menu-close]');
var breakpoint = window.matchMedia('(max-width:766px)');
var menuClickHandler = function menuClickHandler(evt) {
...
var initMobileMenu = function initMobileMenu() {
  if (mobileMenuElement && breakpoint.matches) {
    ...
    menuToggleElement.addEventListener('change', function (evt) {
